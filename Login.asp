...
%>
<%
If (CStr(Request("MM_update")) = "name") Then
...
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess = "TheFirstPage1.asp"
...
<body>
            ...
            <div class="mysign">
                <div class="col-lg-11 text-center text-info">
                    <h2>学生请登录</h2>
                   <p style="text-align:left"><a href="LoginforM.asp">如果你是管理员，戳我</a></button></p>
                   <p style="text-align:left"><a href="LoginforT.asp">如果你是教师，戳我</a></button></p>
                </div>
               <form ACTION="<%=MM_editAction%>" METHOD="POST" name="name" id="name">
                <div class="col-lg-10">
                ...
                <input type="hidden" name="MM_update" value="name">
